...
(* OASIS_START *)
(* DO NOT EDIT (digest: e046d14ad2983ac640866a6210a8b03d) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for JSON pointer";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "json-pointer"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "eval.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\129Ö\152~)2\136ZXª\128\139\129Ë\154E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
